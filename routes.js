...
var organization = require('./service/organization/organization');
var unit = require('./service/unit/unit');
var indicator = require('./service/indicator/indicator');
...
exports = module.exports = function(app, passport) {
  ...
  // organizations
  app.post('/api/v0.1/organizations', organization.create)
  app.get('/api/v0.1/organizations', organization.read)
  app.put('/api/v0.1/organizations/:id/', organization.update)
  app.delete('/api/v0.1/organizations/:id/', organization.delete)

  // units
  app.get('/api/v0.1/units', unit.read)
  app.get('/api/v0.1/units/:id/indicators', unit.readIndicators)

  // indicators
  app.get('/api/v0.1/indicators/', indicator.read)
  app.get('/api/v0.1/indicators/:indicator_id/values/last', indicator.readLastValue)
  app.get('/api/v0.1/indicators/pull', indicator.pullRecentData)
